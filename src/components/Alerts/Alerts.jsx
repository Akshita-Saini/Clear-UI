...
function Alerts()
{
    return (
        ...
        <CodeSnippet heading="Alerts" description="These are the various alerts." code={[` <div className="alert"><Info /> <span className="alert-text">Info Alert: A new update is available.</span></div>`,
